...
MarvinImageMask.prototype.addRectRegion = function (
  startX,
  startY,
  regionWidth,
  regionHeight
...
GaussianBlur.prototype.getGaussianKernel = function () {
  var l_matrix = MarvinJSUtils.createMatrix2D(
    this.radius * 2 + 1,
    this.radius * 2 + 1
  );
...
ThresholdingNeighborhood.prototype.process = function (
  ...
  var thresholdPercentageOfAverage = getAttribute(
...
Moravec.prototype.process = function (
  ...
  var cornernessMap = MarvinJSUtils.createMatrix2D(
    tempImage.getWidth(),
    tempImage.getHeight(),
    0
  );
  var cornernessMapOut = MarvinJSUtils.createMatrix2D(
    tempImage.getWidth(),
    tempImage.getHeight(),
    0
  );
...
var marvinLoadPluginMethods = function (callback) {
  ...
  Marvin.alphaBoundary = function (imageIn, imageOut, radius) {
    ...
    Marvin.plugins.alphaBoundary.process(
      imageIn,
      imageOut,
      null,
  ...
  Marvin.blackAndWhite = function (imageIn, imageOut, level) {
    ...
    Marvin.plugins.blackAndWhite.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.boundaryFill = function (imageIn, imageOut, x, y, color, threshold) {
    ...
    if (threshold != null) {
      Marvin.plugins.boundaryFill.setAttribute("threshold", threshold);
    }

    Marvin.plugins.boundaryFill.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.brightnessAndContrast = function (
    imageIn,
    imageOut,
    brightness,
    contrast
    ...
    Marvin.plugins.brightnessAndContrast.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.colorChannel = function (imageIn, imageOut, red, green, blue) {
    ...
    Marvin.plugins.colorChannel.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.halftoneErrorDiffusion = function (imageIn, imageOut) {
    Marvin.plugins.halftoneErrorDiffusion.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.floodfillSegmentation = function (imageIn) {
    ...
    Marvin.plugins.floodfillSegmentation.setAttribute(
      "returnType",
      "MarvinSegment"
    );
    Marvin.plugins.floodfillSegmentation.process(
      imageIn,
      null,
      attrOut,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.gaussianBlur = function (imageIn, imageOut, radius) {
    Marvin.plugins.gaussianBlur.setAttribute(
      "radius",
      Marvin.getValue(radius, 3.0)
    );
    Marvin.plugins.gaussianBlur.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.invertColors = function (imageIn, imageOut) {
    Marvin.plugins.invertColors.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.grayScale = function (imageIn, imageOut) {
    Marvin.plugins.grayScale.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.moravec = function (imageIn, imageOut, matrixSize, threshold) {
    ...
    Marvin.plugins.moravec.process(
      imageIn,
      imageOut,
      attrOut,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.morphologicalDilation = function (imageIn, imageOut, matrix) {
    ...
    Marvin.plugins.morphologicalDilation.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.morphologicalErosion = function (imageIn, imageOut, matrix) {
    ...
    Marvin.plugins.morphologicalErosion.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.morphologicalClosing = function (imageIn, imageOut, matrix) {
    ...
    Marvin.plugins.morphologicalClosing.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.prewitt = function (imageIn, imageOut, intensity) {
    Marvin.plugins.prewitt.setAttribute(
      "intensity",
      Marvin.getValue(intensity, 1.0)
    );
    Marvin.plugins.prewitt.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.thresholding = function (
    ...
    Marvin.plugins.thresholding.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
  ...
  Marvin.thresholdingNeighborhood = function (
    imageIn,
    imageOut,
    thresholdPercentageOfAverage,
    neighborhoodSide,
    ...
    Marvin.plugins.thresholdingNeighborhood.setAttribute(
      "thresholdPercentageOfAverage",
      thresholdPercentageOfAverage
    );
    Marvin.plugins.thresholdingNeighborhood.setAttribute(
    ...
    Marvin.plugins.thresholdingNeighborhood.process(
      imageIn,
      imageOut,
      null,
      MarvinImageMask.NULL_MASK,
